...
class main extends JFrame implements ActionListener {
  ...
  private static final String[] VERBS_FOR_SENTENCES = new String[]{"what do you", "how do you",
      "what",
      "who"};
  private static final String[] ANSWER_CONTENT_STATUS = new String[]{/*[0]*/
       "\n" + "Hello! My name is IM Haugaland Bot. " + "\n"
          ...
          + "\n",
      /*[1]*/"\n" + "You learn about programming, security, hardware and software, and media etc." + "\n",
      /*[2]*/
  ...
  public void actionPerformed(ActionEvent e) {
    ...
    String answerContentError = "\n" + "I cannot answer that, please try with a different question.";
  ...
  private void sendMessage(String inputContent, String answerContentError) {
    if (inputContent.toLowerCase().startsWith(VERBS_FOR_SENTENCES[0].toLowerCase())) {
      ...
      if (restInput.toLowerCase().startsWith(NOUNS_FOR_SENTENCES[1][0])) {
        ...
        input.setText(null);
      } else if (restInput.toLowerCase().startsWith(NOUNS_FOR_SENTENCES[1][1])) {
      ...
      if (restInput.toLowerCase().startsWith(NOUNS_FOR_SENTENCES[2][0])) {
        answerContent.append(ANSWER_CONTENT_STATUS[6]);
        input.setText(null);
      } else if (restInput.toLowerCase().startsWith(NOUNS_FOR_SENTENCES[2][1])) {
        answerContent.append(ANSWER_CONTENT_STATUS[7]);
        input.setText(null);
      } else if (restInput.toLowerCase().startsWith(NOUNS_FOR_SENTENCES[2][2])) {
        answerContent.append(ANSWER_CONTENT_STATUS[7]);
        input.setText(null);
      } else if (restInput.toLowerCase().startsWith(NOUNS_FOR_SENTENCES[2][3])) {
      ...
      if (restInput.toLowerCase().startsWith(NOUNS_FOR_SENTENCES[3][0])) {
        answerContent.append(ANSWER_CONTENT_STATUS[9]);
        input.setText(null);
      } else if (restInput.toLowerCase().startsWith(NOUNS_FOR_SENTENCES[3][1])) {
